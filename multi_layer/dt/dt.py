...
tra_model = TrAdaBoost(DecisionTreeClassifier(criterion = "entropy", splitter = "best", max_depth=75), n_estimators=10, Xt=tradaboost_target_data, yt=tradaboost_target_label)
...
with open(r'/home/wang/Desktop/thesis/multi_layer/dt/'+str(au_name)+'/test_acc.txt', 'a') as file:
    file.write("%f\n" %test_acu)
with open(r'/home/wang/Desktop/thesis/multi_layer/dt/'+str(au_name)+'/test_ps.txt', 'a') as file:
    file.write("%f\n" %test_ps)
with open(r'/home/wang/Desktop/thesis/multi_layer/dt/'+str(au_name)+'/test_rc.txt', 'a') as file:
    file.write("%f\n" %test_rs)
with open(r'/home/wang/Desktop/thesis/multi_layer/dt/'+str(au_name)+'/test_f1.txt', 'a') as file:
    file.write("%f\n" %test_f1)
with open(r'/home/wang/Desktop/thesis/multi_layer/dt/'+str(au_name)+'/test_21_acc.txt', 'a') as file:
    file.write("%f\n" %test_21_acu)
with open(r'/home/wang/Desktop/thesis/multi_layer/dt/'+str(au_name)+'/test_21_ps.txt', 'a') as file:
    file.write("%f\n" %test_21_ps)
with open(r'/home/wang/Desktop/thesis/multi_layer/dt/'+str(au_name)+'/test_21_rc.txt', 'a') as file:
    file.write("%f\n" %test_21_rs)
with open(r'/home/wang/Desktop/thesis/multi_layer/dt/'+str(au_name)+'/test_21_f1.txt', 'a') as file:
    file.write("%f\n" %test_21_f1)
