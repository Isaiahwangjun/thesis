...
#tra_model = TrAdaBoost(model.compile(loss = 'sparse_categorical_crossentropy', optimizer = tf.keras.optimizers.Adam(learning_rate=learningrate), metrics = ['accuracy']), n_estimators=10, Xt=tradaboost_target_data, yt=tradaboost_target_label)
...
with open(r'/home/wang/Desktop/thesis/multi_layer/new_result/'+str(au_name)+'/test_acc.txt', 'a') as file:
    file.write("%f\n" %test_acu)
with open(r'/home/wang/Desktop/thesis/multi_layer/new_result/'+str(au_name)+'/test_ps.txt', 'a') as file:
    file.write("%f\n" %test_ps)
with open(r'/home/wang/Desktop/thesis/multi_layer/new_result/'+str(au_name)+'/test_rc.txt', 'a') as file:
    file.write("%f\n" %test_rs)
with open(r'/home/wang/Desktop/thesis/multi_layer/new_result/'+str(au_name)+'/test_f1.txt', 'a') as file:
    file.write("%f\n" %test_f1)
with open(r'/home/wang/Desktop/thesis/multi_layer/new_result/'+str(au_name)+'/test_21_acc.txt', 'a') as file:
    file.write("%f\n" %test_21_acu)
with open(r'/home/wang/Desktop/thesis/multi_layer/new_result/'+str(au_name)+'/test_21_ps.txt', 'a') as file:
    file.write("%f\n" %test_21_ps)
with open(r'/home/wang/Desktop/thesis/multi_layer/new_result/'+str(au_name)+'/test_21_rc.txt', 'a') as file:
    file.write("%f\n" %test_21_rs)
with open(r'/home/wang/Desktop/thesis/multi_layer/new_result/'+str(au_name)+'/test_21_f1.txt', 'a') as file:
    file.write("%f\n" %test_21_f1)
