...
for i, n in enumerate(train_result):
    if n == 5:
        train_result[i] = 0

for i, n in enumerate(test_result):
    if n == 5:
        test_result[i] = 0

for i, n in enumerate(test_21_result):
    if n == 5:
        test_21_result[i] = 0
...
with open(r'/home/wang/Desktop/thesis/ablation/no_tra/result/test_acc.txt', 'a') as file:
    file.write("%f\n" %test_acu)
with open(r'/home/wang/Desktop/thesis/ablation/no_tra/result/test_ps.txt', 'a') as file:
    file.write("%f\n" %test_ps)
with open(r'/home/wang/Desktop/thesis/ablation/no_tra/result/test_rc.txt', 'a') as file:
    file.write("%f\n" %test_rs)
with open(r'/home/wang/Desktop/thesis/ablation/no_tra/result/test_f1.txt', 'a') as file:
    file.write("%f\n" %test_f1)
with open(r'/home/wang/Desktop/thesis/ablation/no_tra/result/test_21_acc.txt', 'a') as file:
    file.write("%f\n" %test_21_acu)
with open(r'/home/wang/Desktop/thesis/ablation/no_tra/result/test_21_ps.txt', 'a') as file:
    file.write("%f\n" %test_21_ps)
with open(r'/home/wang/Desktop/thesis/ablation/no_tra/result/test_21_rc.txt', 'a') as file:
    file.write("%f\n" %test_21_rs)
with open(r'/home/wang/Desktop/thesis/ablation/no_tra/result/test_21_f1.txt', 'a') as file:
    file.write("%f\n" %test_21_f1)
