...
def AT(train_data, train_label, test_data, test_label, valid_data, valid_label, learningrate, epochs_num, batch_size):
    ...
    fp = open('/home/wang/rong/wang/LU_tensor/5class/result/at.txt', "a")
    fp.write(str(x) + "\n")
    fp.close()

    np.savetxt('/home/wang/rong/wang/LU_tensor/5class/output/at_test.txt', result_2.astype(int), fmt='%i')
